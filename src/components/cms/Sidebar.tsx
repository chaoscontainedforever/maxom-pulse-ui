...
export const CMSSidebar = ({ onSignOut }: SidebarProps) => {
  ...
  return (
    <aside className="w-64 bg-white text-gray-700 fixed h-full border-r border-gray-200 shadow-sm">
      <div className="p-4 flex items-center border-b border-gray-100">
        <h2 className="text-xl font-bold flex items-center">
          <span className="text-[#800020]">Maxom.ai</span>
          <span className="ml-2 text-xs py-0.5 px-2 bg-orange-100 rounded text-[#800020] font-normal">Admin</span>
        </h2>
      </div>
      ...
      <div className="absolute bottom-0 w-64 p-4 border-t border-gray-200 bg-white">
        <div className="flex items-center mb-3">
          <div className="w-8 h-8 rounded-full bg-[#800020] flex items-center justify-center text-white font-semibold mr-2">
