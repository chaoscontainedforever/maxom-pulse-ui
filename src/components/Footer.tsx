      ...
      <div className="maxom-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              The voice AI that talks like your team.
            </p>
            <p className="text-sm text-gray-500 italic font-playfair">
              Made By AI & Human
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/solutions" className="text-gray-600 hover:text-maxom-orange transition-colors">Restaurants</Link></li>
              <li><Link to="/solutions" className="text-gray-600 hover:text-maxom-orange transition-colors">Healthcare</Link></li>
              <li><Link to="/solutions" className="text-gray-600 hover:text-maxom-orange transition-colors">Home Services</Link></li>
              <li><Link to="/solutions" className="text-gray-600 hover:text-maxom-orange transition-colors">Fitness Studios</Link></li>
              <li><Link to="/solutions" className="text-gray-600 hover:text-maxom-orange transition-colors">Auto Dealerships</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Maxom.ai. All rights reserved.
          </p>
          <div className="flex space-x-6">
            <a href="#" className="text-gray-600 hover:text-maxom-orange transition-colors">
